            ...
            RaisedButton(
              onPressed: () {
                _adminIDTextEditingController.text.isNotEmpty && _passwordTextEditingController.text.isNotEmpty
                    ...
                    builder: (c)
                    {
                      return ErrorAlertDialog(message: "Plesae write email and password",);
      ...
      snapshot.documents.forEach((result) {
        if(result.data["id"] != _adminIDTextEditingController.text.trim())
        {
        ...
        else
          {
            ...
            Scaffold.of(context).showSnackBar(SnackBar(content: Text("wellcome Dear Admin," + result.data["name"]),));
